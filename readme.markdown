...
Simply copy all of the files to a folder called 'todo' in your PowerShell modules folder (usually 'C:\Users\username\Documents\WindowsPowerShell\Modules' in your 'Documents' folder.
